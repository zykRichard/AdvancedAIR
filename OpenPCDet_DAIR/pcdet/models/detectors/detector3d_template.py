...
class Detector3DTemplate(nn.Module):
    ...
    def _load_state_dict(self, model_state_disk, *, strict=True, finetune=False):
        ...
        for key, val in model_state_disk.items():
            ...
            if key in state_dict and state_dict[key].shape == val.shape:
                if finetune and 'dense_head' in key: #dense_head.heads_list
                    continue
    ...
    def load_params_from_file(self, filename, logger, to_cpu=False, pre_trained_path=None, finetune=False):
        ...
        state_dict, update_model_state = self._load_state_dict(model_state_disk, strict=False, finetune=finetune)
